...
app.get("/latest", rateLimiter({ limit: 20, timer: 60, key: "latest-product" }), getLatestProducts);
app.get("/categories", rateLimiter({ limit: 20, timer: 60, key: "categories" }), getCategories);
